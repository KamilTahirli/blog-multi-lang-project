...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            <a class="dropdown-item" href="{{ route('lang.switch', $lang) }}">
                @if($language == 'az') <div class="d-flex align-items-center font-14">
                    <b>{{__('translate.lang_az')}}</b></div> @endif
                @if($language == 'en') <div class="d-flex align-items-center font-14">
                    <b>{{__('translate.lang_en')}}</b></div> @endif
                @if($language == 'ru') <div class="d-flex align-items-center font-14">
    ...
    <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
            ...
            <img class="img-profile rounded-circle" src="{{ url('users/photos', Auth::user()->photo) }}">
            @else
            <img class="img-profile rounded-circle" src="{{ url('backend/img/no-avatar.png') }}">
            @endif
